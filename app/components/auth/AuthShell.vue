  ...
  <div class="auth-shell fixed inset-0 w-screen bg-[#070b16] text-slate-200 grid place-items-center px-4 overflow-hidden">
    ...
    <div class="relative z-10 flex w-full max-w-md flex-col items-center">
      ...
      <Motion
        ...
        class="text-center mb-8 w-full max-w-sm"
      >
      ...
      <Motion
        ...
        class="w-full rounded-3xl border border-slate-800 bg-[#111827]/70 backdrop-blur-xl p-7 md:p-8 shadow-2xl shadow-black/85 relative card-shine-hover"
      >
        <slot />
        ...
        <AnimatePresence>
          <Motion
            ...
            class="mt-4 rounded-2xl border p-3.5 flex items-start gap-2.5 shadow-xl"
